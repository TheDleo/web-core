...
var Templates = {
  ...
  navBarDropDownTemplate: '<ul class="nav">' +
                            ...
                            '</li>' +
    '</ul>',
  guestUserTemplate:      '<a onclick="Actions.doSignInDialog()" title="Sign In"><li class="icon-signin"></li></a>' +
    '{{#allow_open_registration}}<a onclick="Actions.createAccount()" title="Create an account"><li class="icon-user"></li></a>{{/allow_open_registration}}',
  userInfoTemplate:       '<a onclick="Actions.doProfileDialog()" id="dfProfileLnk" title="Settings"><i class="icon-cogs"></i></a>' +
                            '<a id="dfPasswordLnk" onclick="Actions.doChangePasswordDialog()" title="Change Your Password"><i class="icon-key"></i></a>' +
                            '<a id="dfSignOutLink" onclick="Actions.doSignOutDialog()" title="End Your Session Now">' + '<i class="icon-signout"></i> </a><a id="fs_toggle" onclick="Actions.toggleFullScreen(true)" title="Full Screen"><i class="icon-resize-full"></i></a>',

//      '<div class="btn-group"><a onclick="Actions.doProfileDialog()" id="dfProfileLnk" class="btn btn-inverse" title="Change Your Profile">' +
